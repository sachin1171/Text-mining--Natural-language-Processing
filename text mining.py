...
with open("C:/Users/usach/Desktop/Text Mining/stop.txt","r") as sw:
    stop_words = sw.read()
...
with open("C:/Users/usach/Desktop/Text Mining/positive-words.txt","r") as pos:
...
with open("C:/Users/usach/Desktop/Text Mining/negative-words.txt", "r") as neg:
...
for i in range(1,21):
  ip=[]  
  url="https://www.imdb.com/title/tt11306376/reviews?ref_=tt_ql_3"+str(i)
  response = requests.get(url)
  soup = bs(response.content,"html.parser")# creating soup object to iterate over the extracted content 
  ...
  imdb_review=imdb_review+ip  # adding the reviews of one page to empty list which in future contains all the reviews

# writng reviews in a text file 
with open("imdb1.txt","w",encoding='utf8') as output:
...
stop_words.extend(["helpful","permalink","review","movie","found","sign","vote"])
